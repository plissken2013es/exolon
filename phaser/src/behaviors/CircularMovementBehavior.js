...
export default class CircularMovementBehavior {
  constructor(host) {
    this.host = host;
  ...
  update() {
    ...
    if (this.moveType == "straight_1" || this.moveType == "straight_2") {
      ...
      const x = Math.cos(this.moveAngle) * CircularMovementBehavior.CIRCULAR_MOTION_RADIUS;
      const y = Math.sin(this.moveAngle) * CircularMovementBehavior.CIRCULAR_MOTION_RADIUS;
